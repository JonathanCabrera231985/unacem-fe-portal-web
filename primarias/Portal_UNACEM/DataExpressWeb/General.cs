...
namespace DataExpressWeb
{
    ...
    {
        public string obtenerXSD(string p_codDoc, string p_version, string ambiente)
        {
            string archivo_xsd = "";
            ...
            if (ambiente.Equals("1"))
            {
                ...
                switch (p_version)
                {
                    case "1.0.0":
                        ...
                        {
                            case "01":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\factura.xsd";
                                break;
                            case "03":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\LiquidacionCompra.xsd";
                                break;
                            case "04":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\notaCredito.xsd";
                                break;
                            case "05":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\notaDebito.xsd";
                                break;
                            case "06":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\guiaRemision.xsd";
                                break;
                            case "07":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\comprobanteRetencion.xsd";
                                break;
                            case "05A":   //"E8"://creo ke es esa no star seguro
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\1_0_0\notaDebito_Finance.xsd";
                                break;
                        }
                        break;
                    ...
                    case "1.1.0":
                        ...
                        {
                            case "01":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_1_0\factura.xsd";
                                break;
                            case "03":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_1_0\LiquidacionCompra.xsd";
                                break;
                            case "04":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_1_0\notaCredito.xsd";
                                break;
                            case "05":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\notaDebito.xsd";
                                break;
                            case "06":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_1_0\guiaRemision.xsd";
                                break;
                            case "07":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCimaP\1_0_0\comprobanteRetencion.xsd";
                                break;
                    ...
                    case "2.0.0":
                        ...
                        {
                            case "07":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\2_0_0\ComprobanteRetencion_V2.0.0.xsd";
                                break;
                        }
                        break;
                }
                    ...
                    case "1.0.0":
                        switch (p_codDoc)
                        {
                            case "01":  //"EF":
                                ...
                                break;
                            case "03":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\1_0_0\LiquidacionCompra.xsd";
                                break;
                            case "04":  //"EC":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\1_0_0\notaCredito.xsd";
                                break;
                            case "05":  //"EB":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\1_0_0\notaDebito.xsd";
                                break;
                            case "06":  //"EG"://creo ke es esa no star seguro
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\1_0_0\guiaRemision.xsd";
                                break;
                            case "07":   //"E1"://creo ke es esa no star seguro
                    ...
                    case "1.1.0":
                        switch (p_codDoc)
                        {
                            case "01":
                                ...
                                break;
                            case "03":
                                archivo_xsd = AppDomain.CurrentDomain.BaseDirectory + @"xsdCima\1_1_0\LiquidacionCompra.xsd";
                                break;
                            case "04":
        ...
        public Boolean ValidarEstructuraXSD(string p_doc, string p_codDoc, string p_version, out string p_msj, out string p_msjT, string ambiente)
        {
            ...
            try
            {
                ...
                xsd = obtenerXSD(p_codDoc, p_version, ambiente);
