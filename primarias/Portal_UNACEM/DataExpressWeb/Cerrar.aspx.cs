...
namespace DataExpressWeb
{
    public partial class Cerrar : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session.Clear();
            String pathRequLogin;
            pathRequLogin = System.Configuration.ConfigurationManager.AppSettings["pathRespLogin"];
            Response.Redirect(Server.HtmlEncode(pathRequLogin), false);
        }
    }
}