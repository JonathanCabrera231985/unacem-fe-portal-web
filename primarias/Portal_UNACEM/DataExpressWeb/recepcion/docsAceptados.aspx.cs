...
{
    public partial class docsAceptados : System.Web.UI.Page
    {
        ...
        private void buscar()
        {
            ...
            {
                consulta = consulta + "ET2" + separador;
                if (fecha > 1)
                {
        ...
        {
            Response.Redirect(Server.HtmlEncode("docsAceptados.aspx"));
        }
        ...
        protected void gvFacturas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Aceptar") || e.CommandName.Equals("Rechazar"))
            {
                ...
                {
                    SqlDataSource1.UpdateParameters["documentoXML"].DefaultValue = "<INSTRUCCION><FILTRO><opcion>2</opcion><query>ET1|CA" + P_CLAVEACCESO + "|RC" + P_RUCRECEPTOR + "|RF" + P_RUCPROVEEDOR + "|NA" + P_NUMAUT + "|US" + P_USUARIO + "</query></FILTRO></INSTRUCCION>";
                    SqlDataSource1.Update();
                }
                if (e.CommandName == "Rechazar")
                {
                    SqlDataSource1.DeleteParameters["documentoXML"].DefaultValue = "<INSTRUCCION><FILTRO><opcion>2</opcion><query>ETR|CA" + P_CLAVEACCESO + "|RC" + P_RUCRECEPTOR + "|RF" + P_RUCPROVEEDOR + "|NA" + P_NUMAUT + "|US" + P_USUARIO + "</query></FILTRO></INSTRUCCION>";
