<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="docsAceptados.aspx.cs" Inherits="DataExpressWeb.docsAceptados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <strong>DOCUMENTOS ACEPTADOS</strong></center>
    ...
    <asp:GridView ID="gvFacturas" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Acción">
                <ItemTemplate>
                    &nbsp;
                    <asp:ImageButton ID="ibAceptar" runat="server" CommandName="Aceptar"
                        Height="35px" ImageUrl="~/imagenes/Check-128.png" Width="35px" CommandArgument="<%#((GridViewRow)Container).RowIndex%>" />
                    <asp:ConfirmButtonExtender ID="ibAceptar_ConfirmButtonExtender" runat="server" ConfirmText="El estado del documento cambiará a confirmado"
                        Enabled="True" TargetControlID="ibAceptar">
                    </asp:ConfirmButtonExtender>
                    &nbsp;
                    <asp:ImageButton ID="ibRechazar" runat="server" CommandName="Rechazar"
                        Height="35px" ImageUrl="~/imagenes/Delete-128.png" Width="35px" CommandArgument="<%#((GridViewRow)Container).RowIndex%>" />
                    <asp:ConfirmButtonExtender ID="ibRechazar_ConfirmButtonExtender" runat="server" ConfirmText="El estado del documento estará por verificar"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dataexpressConnectionString %>"
        SelectCommand="SP_Recepcion" SelectCommandType="StoredProcedure" DeleteCommand="SP_Recepcion" DeleteCommandType ="StoredProcedure"
        UpdateCommand="SP_Recepcion" UpdateCommandType="StoredProcedure">
        <DeleteParameters>
            <asp:Parameter DefaultValue="<INSTRUCCION><FILTRO><opcion>2</opcion><query>-</query></FILTRO></INSTRUCCION>" Name="documentoXML" Type="String" />            
        </DeleteParameters>
        <SelectParameters>
            <asp:Parameter DefaultValue="<INSTRUCCION><FILTRO><opcion>1</opcion><query>ET2</query></FILTRO></INSTRUCCION>" Name="documentoXML" Type="String" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter DefaultValue="<INSTRUCCION><FILTRO><opcion>2</opcion><query>-</query></FILTRO></INSTRUCCION>" Name="documentoXML" Type="String" />           
        </UpdateParameters>
