...
namespace Administracion
{
    public partial class clientes : System.Web.UI.Page
    {
        ...
        {
            SqlDataSourceEmpleados.SelectParameters["nombre"].DefaultValue = (txt_nombre.Text.Equals("") ? "-" : txt_nombre.Text);
            SqlDataSourceEmpleados.SelectParameters["ruc"].DefaultValue = (txt_identificacion.Text.Equals("") ? "-" : txt_identificacion.Text);
