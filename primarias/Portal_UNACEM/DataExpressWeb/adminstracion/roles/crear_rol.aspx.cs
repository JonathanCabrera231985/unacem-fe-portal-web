...
namespace Administracion
{
    public partial class crear_rol : System.Web.UI.Page
    {
        ...
        private Boolean ValidarRol(string rol)
        {
            ...
            {
                DB.Conectar();
                DB.CrearComando("select idRol from roles WITH (NOLOCK)  where descripcion=@descripcion AND eliminado='False'");
                DB.AsignarParametroCadena("@descripcion", rol);
