        ...
        onfinishbuttonclick="FinishButton_Click">
            ...
            Width="20%" BorderColor="#3333CC" />
                ...
                <asp:SqlDataSource ID="SqlDataInfoAdic" runat="server" ConnectionString="<%$ ConnectionStrings:dataexpressConnectionString %>"
                    ...
                    SelectCommand="SELECT descripcion, codigo, tipo FROM Catalogo1_C WITH (NOLOCK)  WHERE (tipo = 'Comprobante') AND (codigo = '01')">
							</asp:SqlDataSource>
                    ...
                    SelectCommand="SELECT codigo, descripcion, tipo FROM Catalogo1_C WITH (NOLOCK)  WHERE (tipo = 'Ambiente') order by codigo desc">
							</asp:SqlDataSource>
						</asp:WizardStep>
						<asp:WizardStep runat="server" Title="Detalles" ID="infoDetalles" EnableTheming="True">
							<br />
							<span class="style11"><strong>DETALLES DE FACTURA</strong></span><br />
							<br />
							<table>
								<tr>
								...
								<tr>
									<td colspan="9" align="center">
                                        ...
                                        Width="132px" Height="30px" ValidationGroup="Deta" />
									</td>
								</tr>
								<tr>
									<td>
                ...
                <table class="style9">
                    ...
                    DeleteCommand="DELETE FROM DetallesAdicionalesTemp WHERE (idDetallesAdicionalesTemp = @idDetallesAdicionalesTemp)">
								...
								<SelectParameters>
									...
									<%--<asp:SessionParameter Name="codigoTemp" SessionField="codigoTemp"/>--%>
									<asp:SessionParameter Name="idUser" SessionField="idUser" />
								</SelectParameters>
							</asp:SqlDataSource>
                    ...
                    SelectCommand="SELECT [descripcion], [codigo] FROM [CatImpuestos_C] WITH (NOLOCK)  WHERE ([tipo] = @tipo)">
						...
						<asp:WizardStep ID="Pago" runat="server">
							<span class="style11"><strong>
							<br />
													FORMA DE PAGO&nbsp; FACTURA<br />
							<br />
							</strong></span>
							<table style="width:100%;">
								<tr>
								...
								<tr>
									<td class="style25">
										<asp:DropDownList ID="ddr_pagos" runat="server" 
																	DataSourceID="SqlDataSource1pago" DataTextField="descripcion" 
																	DataValueField="codigo" Width="268px">
										</asp:DropDownList>
									</td>
									<td>
										<asp:TextBox ID="tbplazo" runat="server" Height="19px" 
																	ValidationGroup="InfoAdic" Width="334px">0</asp:TextBox>
										<asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" 
																	Enabled="True" FilterType="Custom, Numbers" TargetControlID="tbplazo">
										</asp:FilteredTextBoxExtender>
									</td>
									<td>
																&nbsp;</td>
								...
								<tr>
									<td class="style25">
										<asp:TextBox ID="tbtotal_pago" runat="server" Height="19px" Width="281px">0</asp:TextBox>
										<asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" 
																	Enabled="True" FilterType="Custom, Numbers" TargetControlID="tbtotal_pago" 
																	ValidChars=",.">
										</asp:FilteredTextBoxExtender>
									</td>
									<td>
										<asp:TextBox ID="tbUMedida" runat="server" Height="19px" 
																	ValidationGroup="InfoAdic" Width="334px"></asp:TextBox>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
																	ControlToValidate="tbUMedida" CssClass="style20" ErrorMessage="*" 
								...
								<tr>
									<td class="style25" colspan="2">
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<asp:Button ID="Btn_pagos" runat="server" OnClick="Btn_pagos_Click" 
																	Text="Agregar Pago" />
									</td>
									<td>
																&nbsp;</td>
								...
								<tr>
									<td class="style25" colspan="2">
										<asp:GridView ID="GridDetPago" runat="server" AutoGenerateColumns="False" 
																	BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" 
																	CellPadding="4" DataSourceID="SqlDataSourcedetallePago" ForeColor="Black" 
																	GridLines="Vertical" Width="80%">
											<AlternatingRowStyle BackColor="White" />
											<Columns>
												<asp:BoundField DataField="codigoTempp" HeaderText="codigo" 
													SortExpression="codigoTempp" />
												<asp:BoundField DataField="descripcion" HeaderText="Forma de Pago" 
													SortExpression="descripcion" />
												<asp:BoundField DataField="plazoTemp" HeaderText="Plazo" 
													SortExpression="plazoTemp" />
												<asp:BoundField DataField="totalPagoTemp" HeaderText="Total" 
													SortExpression="totalPagoTemp" />
												<asp:BoundField DataField="unidadTiempoTemp" HeaderText="UnidadTiempo" 
													SortExpression="unidadTiempoTemp" />
												<asp:TemplateField>
													<ItemTemplate>
										...
										<asp:SqlDataSource ID="SqlDataSourcedetallePago" runat="server" 
																	ConnectionString="<%$ ConnectionStrings:invoicecConnectionString %>" 
																	
											SelectCommand="select codigoTempp, b.descripcion, plazoTemp,totalPagoTemp,unidadTiempoTemp   from PagoTemp WITH (NOLOCK) inner join Catalogo1_C B WITH (NOLOCK) on formaPagoTemp = b.codigo  and b.tipo = 'pagos' where id_Empleado=@idUser" 
											DeleteCommand="PA_eliminar_PagosTemp" DeleteCommandType="StoredProcedure">
											<DeleteParameters>
												<asp:Parameter Name="codigoTempp" Type="String" />
											</DeleteParameters>
											<SelectParameters>
												<asp:SessionParameter Name="idUser" SessionField="idUser" />
											</SelectParameters>
								...
								<tr>
									<td class="style25">
										<asp:SqlDataSource ID="SqlDataSource1pago" runat="server" 
																	ConnectionString="<%$ ConnectionStrings:invoicecConnectionString %>" 
																	SelectCommand="select descripcion,codigo from Catalogo1_C WITH (NOLOCK) where tipo='Pagos' ">
										</asp:SqlDataSource>
									</td>
									<td>
																&nbsp;</td>
						...
						<asp:WizardStep runat="server" Title="Documento" ID="infoDocumentos">
							<br />
							<div class="style5">
								<span class="style4">Información de la Factura<br /> </span>
							</div>
							<table class="style13">
								<tr>
									<td class="style24">
                                ...
                                Visible="False"></asp:Label>
										<br />
										<asp:TextBox ID="tbGuiaRemision" runat="server" Height="19px" Width="185px" 
                                Visible="False"></asp:TextBox>
									...
									<td>
										...
										<br />
										<asp:TextBox ID="tbFechaEmision" runat="server" Height="19px" Width="185px" ReadOnly="False"></asp:TextBox>
										<asp:CalendarExtender ID="tbFechaEmision_CalendarExtender" 
                                runat="server" Enabled="True" Format="dd/MM/yyyy" 
                                TargetControlID="tbFechaEmision">
										</asp:CalendarExtender>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                ControlToValidate="tbFechaEmision" CssClass="style25" 
                                ErrorMessage="*" style="color: #FF0000"></asp:RequiredFieldValidator>
                                ...
                                TextMode="MultiLine"></asp:TextBox>
									...
									<td>
										...
										<br />
										<asp:TextBox ID="tbMoneda" runat="server" Height="19px" MaxLength="15" Width="70px"
                                Visible="false">DOLAR</asp:TextBox>
										<br />
                            ...
                            &nbsp;<asp:TextBox ID="tbContribuyenteEspecial" runat="server" MaxLength="4" Width="51px"
                                ...
                                Width="150px" Visible="false">0</asp:TextBox>
                                ...
                                AutoPostBack="True" OnTextChanged="tbPropinas_TextChanged" Visible="false">0</asp:TextBox>
                                ...
                                runat="server" Enabled="True" FilterType="Custom, Numbers" TargetControlID="tbIdentificacionComprador">
										...
										<asp:AutoCompleteExtender ID="tbIC_AutoCompleteExtender" runat="server" CompletionInterval="5"
                                CompletionListCssClass="CompletionListCssClass" CompletionSetCount="5" DelimiterCharacters=""
                                ...
                                CssClass="style20" ValidationGroup="Receptor"></asp:RegularExpressionValidator>
										<br />
										<br />
										<asp:Label ID="lTipoIdentificacionComprador" runat="server" Text="IDENTIFICACIÓN DEL COMPRADOR"
                            ...
                            &nbsp;&nbsp;<asp:DropDownList ID="ddlTipoIdentificacion" runat="server" DataSourceID="SqlDataTipoIdentificacion"
                                ...
                                ErrorMessage="*" Style="color: #FF0000" ValidationGroup="Receptor"></asp:RequiredFieldValidator>
										...
										<br />
										<asp:TextBox ID="txt_dir_cli" runat="server" Height="46px" Width="291px" TextMode="MultiLine"></asp:TextBox>
										<br />
									</td>
								</tr>
								<caption>
                                ...
                                &nbsp;&nbsp;
                                <asp:TextBox ID="txt_fono" runat="server" Height="19px" MaxLength="15" Width="100px"></asp:TextBox>
											<asp:FilteredTextBoxExtender ID="txt_fono_FilteredTextBoxExtender" runat="server"
                                    Enabled="True" FilterType="Custom, Numbers" TargetControlID="txt_fono" ValidChars=",-">
											</asp:FilteredTextBoxExtender>
											<br />
											<span class="style10">Formato: 
											<a href="mailto:email1@email.com,email2@email.com">email1@email.com,email2@email.com</a>
											</span>
											<br />
											<span class="style10">
											<asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server"
                                        ControlToValidate="tbEmail" ErrorMessage="El formato de Email no es válido" ForeColor="Red"
