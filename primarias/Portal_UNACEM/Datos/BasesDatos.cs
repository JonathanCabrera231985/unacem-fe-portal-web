...
namespace Datos
{
    public class BasesDatos
    {
        ...
        private DbTransaction transaccion2 = null;
        ...
        public void Configurar()
        {
            try
            {
                ...
                this.cadenaConexion = ConfigurationManager.AppSettings.Get("CADENA_CONEXION");
																this.cadenaConexion2 = ConfigurationManager.AppSettings.Get("CADENA_CONEXION_HISTORICA");
        ...
        public void Desconectar([CallerMemberName] string memberName = "",
                           ...
                           [CallerLineNumber] int lineNumber = 0)
        {
            try
            {
                if (this.conexion != null)
                {
                    if (this.conexion.State.Equals(ConnectionState.Open))
                    {
                        clsLogger.Graba_Log("Cerrando conexión.", "InfoDB", null, memberName, filePath, lineNumber);
        ...
        public void Desconectar2([CallerMemberName] string memberName = "",
                        [CallerFilePath] string filePath = "",
                        [CallerLineNumber] int lineNumber = 0)
        {
            try
        ...
        /// 
        public void Conectar([CallerMemberName] string memberName = "",
                              [CallerFilePath] string filePath = "",
                              [CallerLineNumber] int lineNumber = 0)
        {
            ...
            try
            {
                if (this.conexion != null && !this.conexion.State.Equals(ConnectionState.Closed))
                {
                    ...
                    if (this.conexion.State == ConnectionState.Connecting)
                    {
                        return;
                    }
                    clsLogger.Graba_Log("Cerrando conexión.", "InfoDB", null, memberName, filePath, lineNumber);
                ...
                clsLogger.Graba_Log("Abriendo conexión.", "InfoDB", null, memberName, filePath, lineNumber);
        ...
        //    }
        //}
        public void Conectar2([CallerMemberName] string memberName = "",
                              [CallerFilePath] string filePath = "",
                              [CallerLineNumber] int lineNumber = 0)
        {
            ...
            try
            {
                if (this.conexion2 != null && !this.conexion2.State.Equals(ConnectionState.Closed))
                {
                    ...
                    if (this.conexion2.State == ConnectionState.Connecting)
                    {
                        return;
                    }
                    clsLogger.Graba_Log("Cerrando conexión.", "InfoDB", null, memberName, filePath, lineNumber);
                ...
                if (this.conexion2 == null)
                {
                    this.conexion2 = factory.CreateConnection();
                    this.conexion2.ConnectionString = cadenaConexion;
                }
                this.conexion2.Open();
            }
            catch (DataException ex)
        ...
        //public void Conectar2()
								...
								//								{
								//												this.conexion2 = factory.CreateConnection();
								//												this.conexion2.ConnectionString = cadenaConexion2;
								//								}
								//								this.conexion2.Open();
								//				}
								//				catch (DataException ex)
        ...
        public void CrearComando(string sentenciaSQL)
        {
            ...
            if (this.transaccion != null)
            {
                this.comando.Transaction = this.transaccion;
								...
								public void CrearComando2(string sentenciaSQL)
								{
												this.comando = factory.CreateCommand();
												this.comando.Connection = this.conexion2;
												this.comando.CommandType = CommandType.Text;
												this.comando.CommandText = sentenciaSQL;
												if (this.transaccion2 != null)
												{
																this.comando.Transaction = this.transaccion2;
												}
								}
        ...
        public DataSet DS()
        {
            ...
            command.CommandText = "select * from ventatmp WITH (NOLOCK)";
            Conectar();
        ...
        public DbDataReader EjecutarConsulta([CallerMemberName] string memberName = "",
                            [CallerFilePath] string filePath = "",
                            [CallerLineNumber] int lineNumber = 0)
        {
            clsLogger.Graba_Log($"Ejecutando consulta: {this.comando.CommandText}", "InfoDB", this.comando.Parameters, memberName, filePath, lineNumber);

            try
            {
                var retu = this.comando.ExecuteReader();
                return retu;
            }
            catch (Exception ex)
            {
                clsLogger.Graba_Log_Error($"Error en consulta: {ex.Message}", null, memberName, filePath, lineNumber);
                throw;
            }
        ...
        /// </summary>
        /// <exception cref="BaseDatosException">Si ocurre un error al ejecutar el comando.</exception>
       public void EjecutarConsulta1([CallerMemberName] string memberName = "",
                               [CallerFilePath] string filePath = "",
                               [CallerLineNumber] int lineNumber = 0)
        {
            clsLogger.Graba_Log($"Ejecutando consulta: {this.comando.CommandText}", "InfoDB", this.comando.Parameters, memberName, filePath, lineNumber);
            ...
            try
            {
                using (var x = this.comando.ExecuteReader())
                {
                }
            }
            catch (Exception ex)
        ...
        public System.Data.DataSet TraerDataset(string ProcedimientoAlmacenado, params System.Object[] Args)
        {
            ...
            return mDataSet;
								...
								public System.Data.DataSet TraerDataset2(string ProcedimientoAlmacenado, params System.Object[] Args)
								{
												System.Data.DataSet mDataSet = new System.Data.DataSet();
												mTransaccion = this.conexion2.BeginTransaction(System.Data.IsolationLevel.Serializable);
												System.Data.IDataAdapter ida = this.CrearDataAdapter2(ProcedimientoAlmacenado, Args);
												ida.Fill(mDataSet);
												mTransaccion.Commit();
												Desconectar2();
												return mDataSet;
                ...
                if (ds != null)
                    foreach (DataTable dt in ds.Tables)
                        foreach (DataRow dr in dt.Rows)
                            TraerDataset(dt.TableName, dr.ItemArray);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet TraerDataSetConsulta(String ComandoSelect, params System.Object[] Args)
        {
            ...
            return mDataASet;
								...
								public DataSet TraerDataSetConsulta2(String ComandoSelect, params System.Object[] Args)
								{
												DataSet mDataASet = new DataSet();
												mTransaccion = this.conexion.BeginTransaction(System.Data.IsolationLevel.Serializable);
												System.Data.IDataAdapter ida = this.CrearDataAdapterSelect(ComandoSelect, Args);
        ...
        protected System.Data.IDataAdapter CrearDataAdapter(string ProcedimientoAlmacenado, params System.Object[] Args)
        {
            ...
            return (System.Data.IDataAdapter)Da;
								...
								protected System.Data.IDataAdapter CrearDataAdapter2(string ProcedimientoAlmacenado, params System.Object[] Args)
								{
												System.Data.SqlClient.SqlDataAdapter Da = new System.Data.SqlClient.SqlDataAdapter((System.Data.SqlClient.SqlCommand)Comandos2(ProcedimientoAlmacenado));
												if (Args.Length != 0)
																CargarParametros(Da.SelectCommand, Args);
												return (System.Data.IDataAdapter)Da;
								}
        ...
        protected System.Data.IDbCommand Comandos(string ProcedimientoAlmacenado)
        {
            ...
            return (System.Data.IDbCommand)Com;
								...
								protected System.Data.IDbCommand Comandos2(string ProcedimientoAlmacenado)
								{
												System.Data.SqlClient.SqlCommand Com;
												Com = new System.Data.SqlClient.SqlCommand(ProcedimientoAlmacenado, (System.Data.SqlClient.SqlConnection)this.conexion2);
												//Com.CommandTimeout = 0;
												Com.Transaction = (System.Data.SqlClient.SqlTransaction)this.mTransaccion;
        ...
        protected void CargarParametros(System.Data.IDbCommand Com, System.Object[] Args)
        {
            ...
            {
                System.Data.SqlClient.SqlParameter P1 = (System.Data.SqlClient.SqlParameter)Com.Parameters[i - 1];
